...
def send_command(n, sock, coordinator_ip, debug_port, hw_id, pos_id):
    ...
    print(
        f"Sent command: Header={header}, HW_ID={hw_id}, Pos_ID={pos_id}, State={state}, Trigger Time={trigger_time}, Terminator={terminator}")
        ...
        if len(data) == 9:
            ...
            if header == 77 and terminator == 88:
                ...
                if print_telemetry[0]:
                    print(
                        f"Received telemetry: Header={header}, HW_ID={hw_id}, Pos_ID={pos_id}, State={state}, Trigger Time={trigger_time}, Terminator={terminator}")
            else:
